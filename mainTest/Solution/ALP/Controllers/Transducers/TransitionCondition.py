        ...
        if charIndexes == [None]:
            ...
            if self.Type == 'str':
                ...
                if self.Key in word.__getattribute__(self.AttributeName).keys():
                    if re.search(self.Value, str(word.__getattribute__(self.AttributeName)[self.Key]),
                                 re.UNICODE) != None:
                        return True
                ...
                # Test Needed ------------------------------------------------------------------------------------------------------
                if re.search(self.Value, str(word.__getattribute__(self.AttributeName)[int(self.Key)]),
                             re.UNICODE) != None:
                    return True
            ...
            if self.Type == 'str':
                ...
                try:
                    ...
                    print('word.__getattribute__(self.AttributeName) = ' + str(
                        word.__getattribute__(self.AttributeName)))
                    print('word.__getattribute__(String) = ' + str(word.__getattribute__('String')))
                    print('charIndexes = ' + str(charIndexes))
