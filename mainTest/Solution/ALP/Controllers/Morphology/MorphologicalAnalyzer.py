...
'''
from ....ALP.Models.Lexicon.RootsAndPatternsRepository import *
from ....ALP.Models.Lexicon.LettersConstants import *
from ....ALP.Models.Lexicon.LettersConstants import *
from ....ALP.Models.Tagging.POSTags.CliticlessPOS import *
from ....ALP.Models.Tagging.POSTags.NominalPOS import NominalPOSConstants

from ....ALP.Controllers.General.ArabicStringUtility import ArabicStringUtility
from ....ALP.Controllers.Morphology.Cliticlization.ProcliticsGrammers import ProcliticsGrammers
from ....ALP.Controllers.Morphology.Cliticlization.EncliticsGrammers import EncliticsGrammers
from ....ALP.Controllers.Morphology.Entities.Particle import *
...
from ....ALP.Controllers.Morphology.Entities.SurfaceFormMorphemes import SurfaceFormMorphemes
    ...
    def Match(self, word):
        ...
        while i < len(affixationPossibilities):
            ...
            if (cliticlessWithDiacritics.endswith(DiacriticsConstants.Sukoon) and \
                            cliticlessWithDiacritics[
                                    len(cliticlessWithDiacritics) - 2] not in EllaConstants.AllAhrofElla):
                isVerb = True
