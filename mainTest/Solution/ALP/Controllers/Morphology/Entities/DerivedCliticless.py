...
from .....ALP.Controllers.Morphology.Entities.Particle import Particle, ParticleConstants

from .....ALP.Models.Lexicon.RootAndPatterns.UnvoweledPattern import UnvoweledPattern
from .....ALP.Models.Lexicon.RootAndPatterns.VoweledPattern import VoweledPattern
from .....ALP.Models.Lexicon.RootAndPatterns.Root import Root
from .....ALP.Models.Lexicon.LettersConstants import DiacriticsConstants, HamzaConstants

from .....ALP.Models.Tagging.POSTags.CliticlessPOS import CliticlessPOSConstants
from .....ALP.Models.Tagging.POSTags.VerbalPOS import VerbalPOSConstants
from .....ALP.Models.Tagging.POSTags.NominalPOS import NominalPOSConstants, NominalPOS
from .....ALP.Models.Tagging.POSTags.ParticlePOS import ParticlePOSConstants
    ...
    def FillDiacritizedForm(self):
        ...
        for i in range(len(self.VoweledPattern.VoweledForm)):
            ...
            if (self.VoweledPattern.VoweledForm[i] not in DiacriticsConstants.AllDiacritics \
                        or (wordIndexCounter != len(self.UnvoweledForm) and self.VoweledPattern.VoweledForm[i] ==
                    self.UnvoweledForm[wordIndexCounter])):
                wordIndexCounter += 1
