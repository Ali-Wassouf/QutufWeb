...
from ....ALP.Controllers.Morphology.Entities.GreedyMorphemes import *
from ....ALP.Controllers.Tokenization.TokenType import *
...
from ....ALP.Controllers.Morphology.Entities.DerivedCliticless import *
...
class Word(object):
    ...
    def GetDiacratic(self, procliticString, searchFromRight=False):
        ...
        return ArabicStringUtility.GetDiacratic(ArabicStringUtility, self.FirstNormalizationForm, procliticString, 0,
                                                searchFromRight)
