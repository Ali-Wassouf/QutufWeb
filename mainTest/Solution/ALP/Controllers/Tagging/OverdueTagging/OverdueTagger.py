...
from .....ALP.Controllers.Tagging.RuleBasedExpertSystemTagger import RuleBasedExpertSystemTagger
from .....ALP.Controllers.Morphology.Entities.SurfaceFormMorphemes import SurfaceFormMorphemes
from .....ALP.Controllers.TextEntities import *
            ...
            for word in sentence.Words:
                ...
                for surfaceFormMorphemes in word.SurfaceFormMorphemes:
                    if (overdureTaggingTopReservants != None and \
                                    ...
                                    newSurfaceFormMorphemes[len(
                                        newSurfaceFormMorphemes) - 1].GetCertainty() != surfaceFormMorphemes.GetCertainty()):
                        break
