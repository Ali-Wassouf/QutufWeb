...
from ...Controllers.Models.Lexicon.RootsAndPatternsRepository import *
from ...Controllers.Models.Lexicon.SpecialWords.StandAloneParticle import *
from ...Controllers.Models.Lexicon.SpecialWords.ProperNoun import *
